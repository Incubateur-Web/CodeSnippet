      ...
      <form>
        <div class="flex flex-col justify-around align-center flex-wrap">
          <div class="w-full mx-auto">
            ...
            <div class="flex flex-col pt-4 form-group">
              <label for="description" class="text-lg text-default">Description</label>
              <textarea type="text" name="description" placeholder="Description" id="description" v-model="group.description" class="appearance-none border-none rounded w-full py-2 px-3 text-gray-700 bg-gray-300 mt-1 leading-tight focus:outline-none focus:shadow-outline p-2" rows="3"></textarea>
            </div>
            <div class="mt-5">
